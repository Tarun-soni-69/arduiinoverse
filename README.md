...
<p align="center">
<img src="https://img.shields.io/github/repo-size/ArduinoVerse/portfolio-html?color=green&label=project%20size">
<a href="#/issues?q=is%3Aopen+is%3Aissue">
<img src="https://img.shields.io/github/issues-raw/ArduinoVerse/portfolio-html?color=green">
</a>
<a href="#/labels/good%20first%20issue">     
<img src="https://img.shields.io/github/labels/ArduinoVerse/portfolio-html/good%20first%20issue">
</a>
<a href="#/labels/help%20wanted"> 
<img src="https://img.shields.io/github/labels/ArduinoVerse/portfolio-html/help%20wanted">
</a>
<a href="#/labels/bug">
<img src="https://img.shields.io/github/labels/ArduinoVerse/portfolio-html/bug">
</a>
<a href="#/labels/enhancement"> 
<img src="https://img.shields.io/github/labels/ArduinoVerse/portfolio-html/enhancement">
</a>
...
<p align="center">Build your portfolio using this super easy template. Free to use if you are a member of the community or a contributor to this project. If not, read our <a href="#/blob/main/REQUIREMENTS.md">requirements</a> if you plan on using this template for your portfolio.</p>
...
<a href="https://gitpod.io/https:/ArduinoVerse/portfolio-html"><img src="https://gitpod.io/button/open-in-gitpod.svg"></a>

## Design credit: 
- <a href="https://github.com/ArduinoVerse">ArduinoVerse</a>
...
- <a href="https://github.com/frankiefab100">ArduinoVerse U.O. Ohaegbulam</a>
- <a href="https://openpeeps.com/">Open Peeps Illustration</a> by <a href="https://twitter.com/pablostanley">Pablo Stanley</a> 

## How to Contribute

Are you contributing to this project, please ensure all pull requests and contributions comply with our <a href="#/blob/main/CONTRIBUTING.md">guidelines.</a>

Before making any changes, ensure you have raised an issue <a href="#/issues/new/choose">here</a>, unless it is a minimal change like Typo error then you can go right ahead.
...
Also learn about metatags and how to generate them for SEO optimization <a href="#/blob/main//Metatags.md">here</a>.
...
<ul class="nav-menu">
   ...
   <li><a class="nav-link btn btn-primary" href="#">Products <i class="fas fa-arrow-right"></i></a>
   </li>     
</ul>
```
...
Replace `ArduinoVerse` with your own name. 
```html
<h1>Hi I'm ArduinoVerse</h1>
```
...
<h2>Productss, brands, and experience.</h2>
```
...
<p>
  ...
  design, brand identity and Products design.
</p>
```
...
```html
<a href="mailto:ArduinoVerse47@gmail.com">ArduinoVerse47@gmail.com</a>
 <div class="social">
